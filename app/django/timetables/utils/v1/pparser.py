...
from timetables.utils.v1 import plexer

class AtomParser(object):
    def __init__(self,_input,group = None):
        self._lexer = plexer.BufferingLexer(_input)
        self._group = group
        self._mult = None
        self._implicit = False

    def parse_template(self):
        from timetables.utils.v1.patternatom import PatternAtom
        self._pattern = PatternAtom(True)
        self._parse_top(True)
        return self._pattern

    def parse_full(self):
        from timetables.utils.v1.patternatom import PatternAtom
        self._pattern = PatternAtom(False)
