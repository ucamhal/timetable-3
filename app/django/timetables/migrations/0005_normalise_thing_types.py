...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Lower case all thing types.
        """
        for thing in orm.Thing.objects.all():
            initial_type = thing.type
            thing.type = thing.type.lower()
            if initial_type != thing.type:
                thing.save()

    def backwards(self, orm):
        """
        Do nothing on backwards migration.
        """
