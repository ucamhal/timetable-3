...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventSource.sourceurl'
        db.alter_column(u'timetables_eventsource', 'sourceurl', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):

        # Changing field 'EventSource.sourceurl'
        db.alter_column(u'timetables_eventsource', 'sourceurl', self.gf('django.db.models.fields.URLField')(max_length=2048, null=True))
